...
#   filter NEVUS
nev = fitz17Data.loc[fitz17Data['diagnosis'] == 'nevus']

#   filtering nevus with needed column
neededListPandas = pd.DataFrame(nev, columns=['image_name'])
...
folder_path = '/Users/babarmuaz/Desktop/skinThesis/DataSets/ISIC_2020'
...
for unwantedImages in unwantedImagesInFolder:
    imagePaths = "/Users/babarmuaz/Desktop/skinThesis/DataSets/ISIC_2020/" + unwantedImages + ".jpg"
    os.remove(imagePaths)

#print("unwanted images are deleted.")
print(len(unwantedImagesInFolder), "unwanted images are deleted, we are left with", len(nev),  "nevus images")
