...
folder_path = '/Users/babarmuaz/Downloads/ISIC_2020/melanoma'
...
for duplicateImages in range(len(neededListPandas)):
    for originalImagesInsideFolder in range(len(totalImagesInFolder)):
        if neededListPandas[duplicateImages] == totalImagesInFolder[originalImagesInsideFolder]:
            ...
            counter = counter + 1
            imagePaths = "/Users/babarmuaz/Downloads/ISIC_2020/melanoma/" + totalImagesInFolder[originalImagesInsideFolder] + ".jpg"
            print(imagePaths)
...
#
# 3 duplicates were found in melanoma and deleted
#Found Match  ISIC_4261232
#Found Match  ISIC_7528783
#584-581
#image_name_2 , this column from duplicates.csv were used